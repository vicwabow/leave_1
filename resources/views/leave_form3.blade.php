	...
	<section class="content">
		<div class="box box-info">
			<div class="box-header with-border">
				<h3 class="box-title"><img src="dist/img/users/dio.png" class="img-circle" width="60px"> Dio 放假單</h3>
			</div>
			<div class="box-body">
			...
			<div class="box-footer">
				<div class="pull-right">
					<button type="reset" class="btn btn-default"><i class="fa fa-undo"></i> 重選對象</button>
