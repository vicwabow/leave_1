...
<section class="content">
	<div class="row">
		<div class="col-md-5">
          ...
          <h3 class="text-center"><span class="label label-default bg-navy">已核准</span></h3>
          <br />
            ...
            <ul class="wizard_steps">
              ...
              <li>
                <a href="#step-2" class="">
                  <span class="step_no">
                    <img src="dist/img/users/suzy.png" title="Suzy" alt="Suzy">
                  </span>
                  <span class="step_descr">
                      Step 2<br />
                      <small>小主管核准</small>
              ...
              <li>
                <a href="#step-3" class="">
                  <span class="step_no">
                    <img src="dist/img/users/default.png" alt="毛毛" title="毛毛" class="">
                  </span>
                  <span class="step_descr">
                      Step 3<br />
                      <small>主管核准</small>
              ...
              <li>
                <a href="#step-4" class="">
                  <span class="step_no">
                    <img src="dist/img/users/neo.png" alt="Neo" class="">
                  </span>
                  <span class="step_descr">
                      Step 4<br />
                      <small>大ＢＯＳＳ核准</small>
