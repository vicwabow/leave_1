		...
		<div class="box box-info">
			...
			<div class="box-body">
				...
				<div class="form-group" id="group_timepicker"><div class="row">
					...
					<div class="col-md-5" id="div_leave_spent_hours">
						<div class="input-group">
							<div class="input-group-addon">
					...
					<div class="col-md-5" id="div_leave_dayrange">
						<div class="input-group">
							<label>
				...
				<div class="form-group"><div class="row">
					...
					<div class="col-md-5">
						<div class="input-group">
							...
							<input type="text" id="leave_reason" name="leave[reason]" class="form-control pull-right">
						</div>
					</div>
					<div class="col-md-1">
						<label>代理人</label>
					...
					<div class="col-md-5">
						<select class="form-control select2" id="leave_agent" name="leave[agent]" multiple="multiple" data-placeholder="請選擇請假日職務代理人">
