              ...
              <li>
                <a href="#step-4" class="disabled">
                  ...
                  <span class="step_descr disabled">
					...
					<div class="form-group" id="group_timepicker"><div class="row">
						<div class="col-md-6">
							<a href="#" class="btn btn-danger btn-block" data-toggle="modal" data-target="#myModalConfirm"><b>不允許</b></a>
						</div>
						<div class="col-md-6">
							<a href="#" class="btn btn-info btn-block" data-toggle="modal" data-target="#myModalConfirm"><b>允許放假</b></a>
						</div>
					</div></div>
				</div>
			<!-- /.box-body -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <h1>確定 <span class="text-red">不允許</span> 此假單嗎？</h1>
      </div>
